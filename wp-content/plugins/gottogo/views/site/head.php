...
<head>
    ...
    <link href="/gottogo/wp-includes/bootstrap/css/bootstrap.css" type="text/css" rel="stylesheet">
    <?php wp_head(); ?>
</head>
<body <?php body_class(); ?>>
<script type="application/javascript" src="/gottogo/wp-includes/bootstrap/js/bootstrap.min.js"></script>
<?php if (is_home()) {
